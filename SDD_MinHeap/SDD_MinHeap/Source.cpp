...
MinHeap* createMaxHeap(int iniSize) {
...
void add(MinHeap* heap, Student* s) {
...
void filterHeap(MinHeap* heap, int index) {
	int root = index;
...
void deleteStudent(MinHeap* heap, int index) {
...
void main() {
	...
	MinHeap* heap = createMaxHeap(100);
